(function(jQuery){
	...
	jQuery.extend({
		...
		addIntoCartProps: function(path, shop_item_id, count, special_props){
			console.log("addIntoCartProps");
			var add_props = '';
			if(typeof(special_props) != 'undefined') add_props = '&special_props=' + special_props;
			$.clientRequest({path: path + '?add=' + shop_item_id + '&count=' + count + add_props, 'callBack': $.addIntoCartCallback, context: $('#little_cart')});
			return false;
		},
